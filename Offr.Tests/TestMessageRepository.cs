...
namespace Offr.Tests
{
    ...
    public class TestMessageRepository
    {
        ...
        public void TestSerialize()
        {
            ...
            List<OfferMessage> l = new List<OfferMessage> { o, o };
            ...
            Assert.AreEqual(l, initialMessageobj, "Expected to load 10 messages");

            //Deserialize<List<IMessage>>(stringBuilder.ToString());
            //[{"OfferText":null,"MoreInfoURL":null,"Location":null,"OfferedBy":null,"Currencies":[],"LocationTags":[],"EndBy":null,"EndByText":null,"IsValid":false,"CreatedBy":null,"Tags":[],"TimeStamp":"\/Date(-62135596800000)\/","Source":null,"HashTags":[],"CommunityTags":[],"MessageType":0}]
            ...
            //[{"OfferText":"For sale: Kitchen jug. #nzd or #barter L:Paekakariki http://bit.ly/234","more_info_url":null,"date":"2009-06-24 ","MoreInfoURL":"http://www.twitter.com/twollar_test_1","Location":null,"OfferedBy":null,"Currencies":[],"LocationTags":[],"EndBy":null,"EndByText":null,"IsValid":false,"CreatedBy":null,"Tags":[],"TimeStamp":"\/Date(-62135596800000)\/","Source":null,"HashTags":[],"CommunityTags":[],"MessageType":0}]
