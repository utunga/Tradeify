...
namespace Offr.Tests
{
   public  class MockLocationProvider:GoogleLocationProvider
    {
       ...
       string json = @"  ""1600 Amphitheatre Parkway, Mountain View, CA"": {
    ""geo_lat"": 37.4217590,
    ""geo_long"": -122.0843700,
  ...
  ""20 Pitt Street,Sydney"": {
    ""geo_lat"": -33.8621908,
    ""geo_long"": 151.2091575,
  ...
  ""30 Fitzroy Street, New Plymouth"": {
    ""geo_lat"": -39.0443705,
    ""geo_long"": 174.1080205,
